...
<main role="main" class="mt-0">
	...
	<div class="table-responsive">
		<form:form action="projectRights" modelAttribute="project" method="post">
			<form:hidden path="id"/>
			...
			<table class="table table-striped table-sm">
				...
				<c:forEach var="user" items="${users}">
					<tr>
						...
						<td>
							<c:choose>
							<c:when test="${!project.users.contains(user)}">
							...
							<c:otherwise>
								<form:checkbox path="users" value="${user.id}" checked="checked"/>
			...
			<div class="row py-4 justify-content-center">
				<div class=" col-4">
					<button id="saveButton" class="btn btn-lg btn-secondary btn-block"
							type="submit">Zapisz
					</button>
				</div>
			</div>
